 ...
 */
package org.apache.ibatis.executor.loader.bytebuddy;
...
public class ByteBuddyProxyFactory implements ProxyFactory {
  ...
  public ByteBuddyProxyFactory() {
    try {
      Resources.classForName("net.bytebuddy.ByteBuddy");
    } catch (Throwable e) {
      throw new IllegalStateException(
          "Cannot enable lazy loading because Byte Buddy is not available. Add Byte Buddy to your classpath.", e);
    }
  }
  ...
  static Object createStaticProxy(Class<?> type, InvocationHandler callback, List<Class<?>> constructorArgTypes,
  ...
  private static class EnhancedResultObjectProxyImpl implements InvocationHandler {
        ...
        synchronized (lazyLoader) {
          if (WRITE_REPLACE_METHOD.equals(methodName)) {
            ...
            if (lazyLoader.size() > 0) {
              return new ByteBuddySerialStateHolder(original, lazyLoader.getProperties(), objectFactory,
                  constructorArgTypes, constructorArgs);
            } else {
              return original;
            }
  ...
  private static class EnhancedDeserializationProxyImpl extends AbstractEnhancedDeserializationProxy
    ...
    public Object invoke(Object enhanced, Method method, Object[] args) throws Throwable {
      ...
      return o instanceof AbstractSerialStateHolder ? o : method.invoke(o, args);
    }
    ...
    protected AbstractSerialStateHolder newSerialStateHolder(Object userBean,
      ...
      return new ByteBuddySerialStateHolder(userBean, unloadedProperties, objectFactory, constructorArgTypes,
          constructorArgs);
    }
  }
